...
/**
 * @brief Cell trait implementation:
 *      collection of methods that comprise
 *      the Cell trait
 */
impl Cell {
 ...
 *     the board
 */
#[derive(Default)] //default Cell values
pub struct Board {
...
/**
 * @brief Board trait implementation:
 *      collection of methods that comprise
 *      the Board trait
 */
impl Board {
